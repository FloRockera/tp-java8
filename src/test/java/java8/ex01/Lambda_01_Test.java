...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        // faire une lambda PersonPredicate à partir d'une interface :
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate predicate2 = p -> p.getFirstname().equals("first_10");
	
        // TODO result ne doit contenir que des personnes dont le prénom est "first_10"
        List<Person> result = filter(personList, predicate2);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate predicate3 = p ->  p.getAge() > 49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
        ...
        List<Person> result = filter(personList, predicate3);
